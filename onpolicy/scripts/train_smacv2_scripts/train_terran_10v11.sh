...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=$GPU_ID nohup  python ../train/train_smac.py --env_name ${env} --algorithm_name ${algo} --experiment_name ${exp} \
    ...
    --gamma 0.99 --lambda 0.95 --huber_delta 10.0 --max_grad_norm 10.0 --data_chunk_length 10 --layer_N 2 --random_search &
done
