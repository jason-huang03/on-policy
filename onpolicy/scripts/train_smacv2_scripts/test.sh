...
do
    ...
    --map_name ${map} --seed ${seed} --units ${units} --n_training_threads 1 --n_rollout_threads 3 --num_mini_batch 1 --episode_length 400 \
    --num_env_steps 20000000 --ppo_epoch 5 --use_value_active_masks \
    --gamma 0.99 --lambda 0.95 --huber_delta 10.0 --max_grad_norm 10.0 --data_chunk_length 10 --layer_N 2 --test 
done
